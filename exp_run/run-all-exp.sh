...
WINDOW_CMDS=(
    "./ns3 run scratch/third -- $EXP_ROOT/config_cc_1_100G.txt $EXP_ROOT 2>&1 | tee $EXP_ROOT/cc_1_output.log"
    "./ns3 run scratch/third -- $EXP_ROOT/config_cc_1_100G_noPFC.txt $EXP_ROOT 2>&1 | tee $EXP_ROOT/cc_1_noPFC_output.log"
    "./ns3 run scratch/third -- $EXP_ROOT/config_cc_3_100G.txt $EXP_ROOT 2>&1 | tee $EXP_ROOT/cc_3_output.log"
    "./ns3 run scratch/third -- $EXP_ROOT/config_cc_3_100G_noPFC.txt $EXP_ROOT 2>&1 | tee $EXP_ROOT/cc_3_noPFC_output.log"
    "./ns3 run scratch/third -- $EXP_ROOT/config_cc_7_100G.txt $EXP_ROOT 2>&1 | tee $EXP_ROOT/cc_7_output.log"
    "./ns3 run scratch/third -- $EXP_ROOT/config_cc_7_100G_noPFC.txt $EXP_ROOT 2>&1 | tee $EXP_ROOT/cc_7_noPFC_output.log"
    "./ns3 run scratch/third -- $EXP_ROOT/config_cc_8_100G.txt $EXP_ROOT 2>&1 | tee $EXP_ROOT/cc_8_output.log"
